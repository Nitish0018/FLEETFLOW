...
import { MapPin, Search, Filter, MoreVertical, Plus } from 'lucide-react';
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-4">
                                ...
                                <div className="pt-4 flex gap-3">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={submitting}
                                        className="flex-1 bg-linear-to-r from-[#00C2FF] to-[#0066FF] text-white text-sm font-medium rounded-xl hover:from-[#00A8E0] hover:to-[#0052D9] transition-all shadow-lg shadow-[#00C2FF]/20 disabled:opacity-50"
                                    >
